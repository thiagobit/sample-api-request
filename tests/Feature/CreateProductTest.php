...
class CreateProductTest extends TestCase
{
    ...
    {
        $this->post(route('api.product.store'), $this->productInputRequest)
            ->assertSuccessful();

        $this->assertDatabaseCount('requests', 1);
        $this->assertDatabaseHas('requests', ['path' => 'products', 'method' => 'post', 'params' => $this->productOutputRequest]);
    }

    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_id()
    {
        ...
        $this->productInputRequest['detail']['product_variant']['id'] = 'a';
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_sku()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_created_at()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_updated_at()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_product()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_product_id()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_product_title()
    {
    ...
    /** @test */
    public function product_can_be_created_with_nullable_product_variant_sourcing_category()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_sourcing_category()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_sourcing_category_id()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_sourcing_category_title()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_id()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_name()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_sku_value()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_attribute()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_attribute_id()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_attribute_name()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_attribute_title()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_options_attribute_attribute_type()
    {
    ...
    /** @test */
    public function product_can_be_created_with_empty_product_variant_images()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_images()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_images_id()
    {
    ...
    /** @test */
    public function product_cannot_be_created_with_invalid_product_variant_images_url()
    {
