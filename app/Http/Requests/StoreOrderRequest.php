...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'detail.order.items.*.sku' => 'string|required_without:detail.order.items.*.barcode|max:64',
            'detail.order.items.*.barcode' => 'string|required_if:detail.order.items.*.customized,true|max:64',
